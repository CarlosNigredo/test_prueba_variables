...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "fallbackExclusionList": [\
      ["test_prueba_variables", ["workspace:."]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      [null, [\
        [null, {\
          "packageLocation": "./",\
          "packageDependencies": [\
            ["@kogpsy/jspsych-staircase", "npm:1.1.2"]\
          ],\
          "linkType": "SOFT"\
        }]\
      ]],\
      ["@kogpsy/jspsych-staircase", [\
        ["npm:1.1.2", {\
          "packageLocation": "./.yarn/cache/@kogpsy-jspsych-staircase-npm-1.1.2-5b1e6fee72-e9ac901f46.zip/node_modules/@kogpsy/jspsych-staircase/",\
          "packageDependencies": [\
            ["@kogpsy/jspsych-staircase", "npm:1.1.2"]\
          ],\
          "linkType": "HARD"\
